...
public class BajaEmpleado extends JInternalFrame implements Observer, Vista {
    ...
    private JComboBox<Emple> empleados;
    ...
    private void loadWindow() {
        ...
        departamentos.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (ItemEvent.SELECTED == e.getStateChange()) {
                    Depart dep = (Depart) e.getItem();
                    try {
                        setEmpleados(dep.getDeptNo());
        ...
        boton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Emple emp = (Emple) empleados.getSelectedItem();

                    if (emp != null) {
                        empleados.removeItem(emp);
                        if (controller.bajaEmpleado(emp)) {
                            mostrarMensaje("** "+ emp.getApellido()
     ...
     * @param departamentos 
     */
    public void setDepartamentos(Depart[] departamentos) {
    ...
    public void setEmpleados(int codigo) throws SQLException {
        ...
        Emple[] empleados = controller.listarEmpleadosPorDepart(codigo);
    ...
    public void update(Observable o, Object arg) {
        try {
            ...
            Depart dep = (Depart) departamentos.getSelectedItem();
            setEmpleados(dep.getDeptNo());
            boton.setEnabled(true);
        } catch (SQLException ex) {
            boton.setEnabled(false);
