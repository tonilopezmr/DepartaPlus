...
public class Principal extends JFrame implements Vista {
    ...
    /**
     * Constructor de la ventana principal donde se muestra la barra de menu.
     *
     */
    public Principal() {
        loadWindow();
        ...
        cerrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            //Ya que hibernate tira excepciones muy raras
                            //quito por si acaso todas las ventanas
                            consultaDepart.setVisible(false);
                            altaDepart.setVisible(false);
                            bajaDepart.setVisible(false);
                            modificarDepart.setVisible(false);
                            altaEmple.setVisible(false);
                            bajaEmple.setVisible(false);
                            modificarEmple.setVisible(false);
                            consultarEmple.setVisible(false);
