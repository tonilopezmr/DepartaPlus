...
public class ConsultarDepart extends JInternalFrame implements Observer, Vista {
     ...
     * @deprecated
     */
    private void addItems(Depart[] items) {
     ...
     * @return
     */
    public Depart[] getDepartamentos() {
    ...
    public void setDepartamentos(Depart[] departamentos) {
        ...
        lista.addItem(new Depart((byte)-1, "NONE"));
        ...
        lista.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    if (dep != null && dep.getDeptNo()!= (byte)-1) {
                        codigoField.setText(dep.getDeptNo()+ "");
